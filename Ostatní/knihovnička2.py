...
def input_to_library():
    ...
    while True:
        ...
        if choice == 1:
            ...
            choice = int(input("Zadej jakou knihu chceš upravit: "))
            for index, book in enumerate(library.books):
                if choice == index + 1:
                    print("1 - Název knihy")
                    print("2 - Autor")
                    ...
                    choice = int(input("Vyber z možnosti: "))
                    if choice == 1:
                        book.name = input("Zadej nový název knihy: ")
                    elif choice == 2:
                        book.author = input("Zadej nové jméno autora: ")
                    elif choice == 3:
                        book.pages = input("Zadej nový počet stran: ")
                    else:
                        print("Chyba!")
                        break
